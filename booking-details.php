...
<table border="1" class="table table-bordered mg-b-0">
  ...
  <tr>
   ...
   <tr>
    ...
    switch ($atype) {
        case "1":
            $ambulanceTypeText = "Howrah Hospital";
            break;
        case "2":
            $ambulanceTypeText = "NRS Medical College";
            break;
        case "3":
            $ambulanceTypeText = "Calcutta Medical College";
            break;
        case "4":
            $ambulanceTypeText = "BR Singh Hospital";
            break;
        default:
     ...
     <?php $query=mysqli_query($con,"select * from tblambulance where Status is null || Status='Reached'");
              ...
              <option value="<?php echo $row3['AmbRegNum'];?>"><?php   $atype=$row3['AmbulanceType'];  
                 if($atype=="1"){ ?>
                  <p>Howrah Hospital</p>
                <?php } elseif($atype=="2"){ ?>
                  <p>NRS Medical College</p>
                <?php } elseif($atype=="3"){ ?>
                   <p>Calcutta Medical College</p>
                   <?php } elseif($atype=="4"){ ?>
                     <p>BR Singh Hospital</p>
