...
if(isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO tblambulancehiring (BookingNumber, PatientName, ContactNum, HiringDate, HiringTime, AmbulanceType, Address, City, State, Message) VALUES ('$bookingnum', '$pname', '$phone', '$hdate', '$htime', '$ambulancetype', '$address', '$city', '$state', '$message')");
...
<head>
  ...
  * Updated: April 27 2025 with Bootstrap v5.3.2
...
?>
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              <select name="ambulancetype" id="ambulancetype" class="form-select">
                ...
                <option value="1">Howrah Hospital</option>
                <option value="2"> NRS Medical College</option>
                <option value="3">Calcutta Medical College</option>
                <option value="4">BR Singh Hospital</option>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Clearly display the emergency services phone number and any relevant instructions.</p>
        </div>
