...
<div class="header">
    ...
    <button class="login-signup" onclick="window.location.href='feedback.php'"><B>FEEDBACK / RATE US!</B></button>
</div>
...
<div class="feature-section">
    <div class="feature">
        ...
        <button onclick="window.location.href='map.php'">SEARCH NEARBY HOSPITALS</button>
    </div>
    ...
    <div class="feature">
        ...
        <button onclick="window.location.href='hospitalbooking.php'">FIND NEARBY DONOR/RECEIVER</button>
    </div>
    ...
    <div class="feature">
        ...
        <button onclick="window.location.href='eahp/index.php'">BOOK YOUR AMBULANCE NOW!</button>
    </div>
</div>
