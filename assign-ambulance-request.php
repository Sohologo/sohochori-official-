...
<!DOCTYPE html>
<head>
<title>EAHP || Assign Ambulance Request</title>
...
$ret=mysqli_query($con,"select * from  tblambulancehiring  where tblambulancehiring.Status='Assigned'");
$cnt=1;
