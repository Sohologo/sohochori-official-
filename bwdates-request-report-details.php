...
<!DOCTYPE html>
<head>
<title>EAHP || B/w Dates Report Details</title>
...
<div class="panel-heading">
            B/w Dates Report of Ambulance Request  From <?php echo $fdate;?> To <?php echo $tdate;?></div>
...
?>
        ...
        <?php
$ret=mysqli_query($con,"select * from  tblambulancehiring  where date(tblambulancehiring.BookingDate) between '$fdate' and '$tdate'");
$cnt=1;
